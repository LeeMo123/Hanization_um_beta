...
DESCRIBE.BOAT_BUMPER_SLUDGE_KIT = "我最擅长砌墙了。"
...
DESCRIBE.UM_THULECITE_RAZOR = "我才不在乎这玩意儿！！"
DESCRIBE.UM_DURIAN_CREAM_MARSHCAKE = "虽然不是我的最爱，但既然是煎饼我就不会拒绝！"
ANNOUNCE.ANNOUNCE_MARSHCAKE_BONUS = {
    SPRING = "话说……蓝莓味的什么时候出？",
    SUMMER = "比我习惯的口感粘了一点，不过味道还行。",
    AUTUMN = "老妈要是看到我吃‘绿色’蔬菜肯定会骄傲的，嘿。",
    WINTER = "他们还说我们整个季节都吃不上煎饼呢！猜猜谁错了？",
}
DESCRIBE.UM_BOOMBERRYPIE = "弄得乱七八糟，但这正是乐趣所在！"